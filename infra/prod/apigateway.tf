...
resource "aws_api_gateway_method" "options_recipe" {
  rest_api_id   = aws_api_gateway_rest_api.enplace.id
...
resource "aws_api_gateway_method_response" "options_recipe" {
  rest_api_id = aws_api_gateway_rest_api.enplace.id
  resource_id = aws_api_gateway_resource.recipe.id
  http_method = aws_api_gateway_method.options_recipe.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration" "options_recipe" {
  rest_api_id = aws_api_gateway_rest_api.enplace.id
  resource_id = aws_api_gateway_resource.recipe.id
  http_method = aws_api_gateway_method.options_recipe.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_integration_response" "options_recipe" {
  depends_on = [
    aws_api_gateway_integration.options_recipe
  ]
